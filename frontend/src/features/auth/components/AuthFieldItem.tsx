    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full bg-greyOneAccent border rounded-lg px-4 py-2.5 text-zinc-600 text-sm outline-none focus:ring-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed
              ${hasError
